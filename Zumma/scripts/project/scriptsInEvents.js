...
const scriptsInEvents = {
		...
		async EventSheet1_Event43_Act11(runtime, localVars)
		{
			...
			const dataObject = {
			    telegram_id: tgId ,
			    game: gameName,
			    score: runtime.globalVars.ochko,
		...
		async EventSheet1_Event44_Act8(runtime, localVars)
		{
			function getParameterByName1(name, url = window.location.href) {
			    name = name.replace(/[\[\]]/g, '\\$&');
			    var regex = new RegExp('[?&]' + name + '(=([^&#]*)|&|#|$)'),
